...
public class Dog extends Adoptable{
     ...
     */
    public Dog(String name, Double age, Double currentWeight, Coord whereabouts) {
        super(name, age, currentWeight, whereabouts);
    }

    /**
     * Returns the age of the selected dog
     *
     * @return double
     */
    ...
    public Double deltaWeight() {
        Double targetWeight = 60000.0d + ((age/12.0d) * 1000);
        Double dWeight = Adoptable.weightRound((abs(targetWeight - currentWeight)), 2);
    ...
    public String toString() {
        return "Dog [name=" + name + ", age=" + age + ", currentWeight=" + currentWeight +"]";
    }
