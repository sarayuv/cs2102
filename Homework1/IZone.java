...
public interface IZone {
     ...
     * @return
     */
    public abstract IZone registerAdoptable(String name, Double age, Double currentWeight, Coord whereabouts);

    /**
     * Calculates the total number of adoptable pets-to-be in the zone that are >= 0 and <= 12 months old
     * @return the calculated total
     */
    public abstract int totalYoungins();
     ...
     */
    public abstract double averageAge();
     ...
     */
    public abstract Adoptable closestTo(Coord location);
     ...
     */
    public abstract LinkedList<Adoptable> weighIn(Double threshold);
